...
_G.packer_plugins = {
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/Users/ignatiyvoronov/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/Users/ignatiyvoronov/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
